...
public class AnimationManager {
    ...
    private Animation shooting = new Animation(50, 0, 1, new String[]{"", "player_pistol", "player_pistolfire"});
    ...
    public void setAnimationShooting() {
        currentAnimation = new Animation(50, 0, 1, new String[]{"player_pistol", "player_pistol", "player_pistolfire"});
    }
